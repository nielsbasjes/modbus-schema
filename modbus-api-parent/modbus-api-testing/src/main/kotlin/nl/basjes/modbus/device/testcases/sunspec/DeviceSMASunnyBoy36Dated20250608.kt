...
object DeviceSMASunnyBoy36Dated20250608 {
    @JvmStatic
    val device: MockedModbusDevice
        get() =
            // Extracted on 2025-06-08 at ~23:15 5-18 from my own SMA SunnyBoy 3.6 after having implemented Modbus read error handling
            builder()
//            .withLogging()
                .withRegisters(
                    HOLDING_REGISTER,
                    ...
                    8000 FFFD 002F 11EA 0001 FFFF 8000 FFFF 8000 8000
                    ...
                    0004 0170 0001 0170 0001 FFFF 8000 8000 00B8 0001
                    ...
                    0000 0000 0000 0000 0000 01D6 B322 0000 0000 0000
                    0000 0000 0000 0000 0000 0000 0000 0000 0000 0000
