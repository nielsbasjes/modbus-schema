...
<#assign fieldReturnType=valueGetter(schemaDevice.getBlock(expectedBlock.blockId).getField(fieldName).returnType)>
<#if fieldReturnType == "longValue">
        assertEquals(${expectedBlock.expected[fieldName][0]}L, ${asVariableName(className)}.${asVariableName(expectedBlock.blockId)}.${asVariableName(fieldName)}.getValue());
...
<#assign tempVariableName>${asVariableName(expectedBlock.blockId)}${asClassName(fieldName)}Value</#assign>
        assertEquals(${expectedBlock.expected[fieldName][0]}, ${asVariableName(className)}.${asVariableName(expectedBlock.blockId)}.${asVariableName(fieldName)}.getValue(), 0.001);
