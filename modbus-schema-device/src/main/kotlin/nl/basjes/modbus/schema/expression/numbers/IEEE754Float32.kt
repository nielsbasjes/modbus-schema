...
) : NotImplemented(nl.basjes.modbus.schema.expression.FLOAT_BYTES / nl.basjes.modbus.schema.expression.BYTES_PER_REGISTER, notImplemented), NumericalExpression {

    override fun toString(): String {
        return "ieee754_32($byteArray)"
    }
